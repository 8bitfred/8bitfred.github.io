...
[*Fred*](https://worldofspectrum.org/archive/software/games/fred-investronica-sa) es un videojuego de acción desarrollado por [Carlos Granados (Charlie)](https://amstrad.es/doku.php?id=programadores:carlos_granados_charlie), [Fernando Rada](https://es.wikipedia.org/wiki/Fernando_Rada) y [Paco Menéndez](https://en.wikipedia.org/wiki/Paco_Men%C3%A9ndez) para el Sinclair ZX Spectrum en 1983, publicado por [Indescomp, S.A.](https://es.wikipedia.org/wiki/Indescomp) en España y por [Quicksilva, Ltd](https://en.wikipedia.org/wiki/Quicksilva) en Reino Unido. La ilustración de la carátula fue realizada por [David Rowe](https://www.davidrowe.net/). Durante 1984 se publicaron versiones para Commodore 64 y Amstrad CPC 464.

Este título presenta características asociadas a los juegos de tipo [*Rogue*](https://en.wikipedia.org/wiki/Rogue_(video_game)), como la generación procedural de laberintos, la exploración, la gestión de recursos y la elevada dificultad, lo que lo convierte en uno de los primeros exponentes españoles de este género.

Junto con su contemporáneo [*La Pulga*](https://es.wikipedia.org/wiki/La_Pulga), *Fred* está considerado uno de los primeros videojuegos desarrollados en España para esta plataforma. Cabe destacar que Indescomp alcanzó un acuerdo para comercializar ambos títulos en Reino Unido durante el otoño de 1983, cuando ambos títulos estaban ya finalizados. No obstante, los lanzamientos se produjeron con unas pocas semanas de diferencia: *La Pulga* a finales de ese año y *Fred* a comienzos de 1984. Ambos fueron grandes éxitos comerciales y recibieron excelentes críticas.
...
La versión para Commodore 64 fue desarrollada en exclusiva por [Pedro Ruiz](https://www.devuego.es/bd/fdesarrollador/pedro-ruiz), miembro del equipo de programación de Indescomp.
