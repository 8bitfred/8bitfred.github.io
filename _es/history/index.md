...
Después de *Fred*, sus autores fundaron el estudio Made in Spain y la distribuidora [Zigurat](https://en.wikipedia.org/wiki/Zigurat_(company)). Produjeron una larga lista de videojuegos para plataformas de 8 y 16 bits, e incluso varios títulos para recreativas (arcade).
