...
This title incorporates features that are now associated with games such as [*Rogue*](https://en.wikipedia.org/wiki/Rogue_(video_game)), including procedurally generated mazes, map exploration, resource management, and a high level of difficulty, anticipating some of the mechanics that would later come to define the *roguelike* genre. In this respect, it represents one of the earliest Spanish video games to incorporate characteristics that would later become hallmarks of the genre.

Together with its contemporary [*Bugaboo (The Flea)*](https://en.wikipedia.org/wiki/Bugaboo_(The_Flea)), *Fred* is one of the landmark titles of the early years of video game development in Spain. Regarding its release, it is worth noting that Indescomp reached an agreement to publish both games in the United Kingdom during the autumn of 1983, when they had already been completed. However, for logistical and promotional reasons, their releases were staggered by a few weeks: *Bugaboo* was released at the end of that year, while *Fred* followed in early 1984. Both titles became major commercial successes and received widespread critical acclaim.
...
The Amstrad CPC conversion was developed by the same team, joined by [Camilo Cela](https://www.devuego.es/bd/fdesarrollador/camilo-cela). It was published by [Amsoft](https://en.wikipedia.org/wiki/Amsoft) in the spring of 1984 under the title [*Roland on the Ropes*](https://www.cpcwiki.eu/index.php/Roland_on_the_Ropes) as part of the well-known [Roland](https://en.wikipedia.org/wiki/Roland_(game_character)) series of video games. Interestingly, [Alan Sugar](https://en.wikipedia.org/wiki/Alan_Sugar), Chief Executive of Amstrad, named the series after [Roland Perry](https://amstrad.com/about-us/), the engineer who led the development of the CPC 464, while watching a demonstration of *Fred*.

The Commodore 64 version was developed exclusively by [Pedro Ruiz](https://www.devuego.es/bd/fdesarrollador/pedro-ruiz), an expert on the platform and a member of Indescomp's programming team.
...
After *Fred*, the team founded the game studio Made in Spain and the distributor [Zigurat](https://en.wikipedia.org/wiki/Zigurat_(company)). They produced a long list of games for 8 and 16 bit platforms, and even a few arcade titles.
